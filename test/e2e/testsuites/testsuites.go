...
import (
	...
	"github.com/kubernetes-csi/csi-driver-nfs-export-export-export-export-export-export/pkg/nfs-export-export-export-export-export-export"
...
func NewTestPod(c clientset.Interface, ns *v1.Namespace, command string) *TestPod {
	testPod := &TestPod{
		...
		pod: &v1.Pod{
			ObjectMeta: metav1.ObjectMeta{
				GenerateName: "nfs-export-export-export-export-export-export-volume-tester-",
			},
			Spec: v1.PodSpec{
...
func (t *TestPersistentVolumeClaim) DeleteBackingVolume(cs *nfs-export-export-export-export-export-export.ControllerServer) {
	volumeID := t.persistentVolume.Spec.CSI.VolumeHandle
	ginkgo.By(fmt.Sprintf("deleting nfs-export-export-export-export-export-export volume %q", volumeID))
	...
	volume := v1.Volume{
		...
		VolumeSource: v1.VolumeSource{
			CSI: &v1.CSIVolumeSource{
				Driver: nfs-export-export-export-export-export-export.DefaultDriverName,
